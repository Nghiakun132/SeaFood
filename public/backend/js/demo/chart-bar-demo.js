...
if (thongke == '7_ngay') {
    ...
    fetch(url, options)
        ...
        .then(data => {
            ...
            var max2 = max.sort(function (a, b) { return b - a; })[0];
            var min = (data.doanhthu).map(function (item) {
                return item.doanhthu;
            });
            ...
            var myBarChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: (data.doanhthu).map(function (item) {
                        return 'Ngày' + ' ' + item.ngay;
                    }),
                    datasets: [{
                        label: "Doanh thu",
                        backgroundColor: "#6c14c5",
                        hoverBackgroundColor: "#2e59d9",
                        borderColor: "#4e73df",
                        data: (data.doanhthu).map(function (item) {
                            return item.doanhthu;
                        }),
                    }],
                },
