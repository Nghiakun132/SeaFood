                    ...
                    <div class="wrap-shop-control">
                        ...
                        <div class="wrap-right">
                            <div class="sort-item orderby">
                                <a href="{{Request::URL()}}?sort_by=moi-nhat" style="margin:8px"><label>Sap xep tang dan</label></a>
                                <a href="{{Request::URL()}}?sort_by=thap-nhat" style="margin:8px"><label>Sap xep giam dan</label></a>
                                <a href="{{Request::URL()}}" style="margin:8px"><label>Sap xep tang dan</label></a>
                                <a href="{{Request::URL()}}" style="margin:8px"><label>Sap xep tang dan</label></a>
                            </div>
                                ...
                                <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                    <div class="product product-style-3 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            <a href="#" class="product-name"><span>{{ $value->pro_name }}</span></a>
